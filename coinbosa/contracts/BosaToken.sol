...
/**
 * @title BosaToken
 * @notice Le jeton officiel Coinbosa (BOSA), au standard BOS20 de Coinbosa Chain.
 *
...
contract BosaToken is BOS20 {
    ...
    constructor(address initialHolder)
        BOS20("Coinbosa", "BOSA", DECIMALS, INITIAL_SUPPLY_WHOLE * (10 ** uint256(DECIMALS)), initialHolder)
    {}
}
