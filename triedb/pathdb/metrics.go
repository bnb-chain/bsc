...
var (
	...
	diskAccountLeftNodeTimer  = metrics.NewRegisteredTimer("pathdb/disk/leftnode/account/timer", nil)
	diskStorageLeftNodeTimer  = metrics.NewRegisteredTimer("pathdb/disk/leftnode/storage/timer", nil)
	readAccLeftNodeTimer      = metrics.NewRegisteredTimer("pathdb/disk/leftnode/account/totaltime", nil)
	readStorageLeftNodeTTimer = metrics.NewRegisteredTimer("pathdb/disk/leftnode/storage/totaltime", nil)
