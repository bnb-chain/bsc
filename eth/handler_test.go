...
func newTestHandlerWithBlocks(blocks int, options ...core.BlockChainOption) *testHandler {
	...
	chain, _ := core.NewBlockChain(db, nil, gspec, nil, ethash.NewFaker(), vm.Config{}, nil, nil, options...)
