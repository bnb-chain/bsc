...
func (c *bls12381MapG1) Run(input []byte) ([]byte, error) {
	...
	// > Field-to-curve call expects `64` bytes an an input that is interpreted as an element of the base field.
...
func (c *bls12381MapG2) Run(input []byte) ([]byte, error) {
	...
	// > Field-to-curve call expects `128` bytes an an input that is interpreted as an element of the quadratic extension field.
