...
//go:embed checkpoints_bsc.json
var checkpointsBscJSON []byte

//go:embed checkpoints_chapel.json
var checkpointsChapelJSON []byte
...
var checkpoints = []checkpointList{
	...
	decodeCheckpoints(checkpointsBscJSON),
	decodeCheckpoints(checkpointsChapelJSON),
}
