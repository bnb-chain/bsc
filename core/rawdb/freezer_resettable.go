...
func newResettableFreezer(datadir string, namespace string, readonly bool, maxTableSize uint32, tables map[string]bool, isIncr bool) (*resettableFreezer, error) {
