...
// NextHardFork Instruction Set
func hardForkConfig() *params.ChainConfig {
	config := *params.TestChainConfig
	config.NextHardForkBlock = big.NewInt(0)
	return &config
}
...
func TestSelfDestructGasPostEIP3529(t *testing.T) {
	...
	testGasUsage(t, hardForkConfig(), ethash.NewFaker(), bytecode, nil, 60_000, expectedGasUsed)
}
...
func TestSstoreModifyGasPostEIP3529(t *testing.T) {
	...
	testGasUsage(t, hardForkConfig(), ethash.NewFaker(), bytecode, initialStorage, 60_000, expectedGasUsed)
}
...
func TestSstoreClearGasPostEIP3529(t *testing.T) {
	...
	testGasUsage(t, hardForkConfig(), ethash.NewFaker(), bytecode, initialStorage, 60_000, expectedGasUsage)
}
