...
func (o *ChainOverrides) apply(cfg *params.ChainConfig) (*params.ChainConfig, error) {
	...
	if o.OverridePassedForkTime != nil {
		cpy.ShanghaiTime = o.OverridePassedForkTime
		cpy.KeplerTime = o.OverridePassedForkTime
		cpy.FeynmanTime = o.OverridePassedForkTime
		cpy.FeynmanFixTime = o.OverridePassedForkTime
		cpy.CancunTime = o.OverridePassedForkTime
		cpy.HaberTime = o.OverridePassedForkTime
		cpy.HaberFixTime = o.OverridePassedForkTime
		cpy.BohrTime = o.OverridePassedForkTime
	}
	if o.OverridePascal != nil {
		cpy.PascalTime = o.OverridePascal
	}
	if o.OverridePrague != nil {
		cpy.PragueTime = o.OverridePrague
	}
