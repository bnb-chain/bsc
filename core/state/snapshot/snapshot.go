...
func (t *Tree) Verify(root common.Hash) error {
	...
	got, err := generateTrieRoot(nil, t.diskdb, "", acctIt, common.Hash{}, stackTrieGenerate, func(db ethdb.KeyValueWriter, reader ethdb.KeyValueReader, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
		...
		hash, err := generateTrieRoot(nil, t.diskdb, "", storageIt, accountHash, stackTrieGenerate, nil, stat, false)
		if err != nil {
			return common.Hash{}, err
		}
		return hash, nil
