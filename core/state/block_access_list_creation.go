...
func (a *AccessListCreationDB) CopyDoPrefetch() BlockProcessingDB {
	return a.inner.CopyDoPrefetch()
}

func (a *AccessListCreationDB) StopPrefetcher() {
	a.inner.StopPrefetcher()
}

func (a *AccessListCreationDB) StartPrefetcher(namespace string, witness *stateless.Witness) {
	a.inner.StartPrefetcher(namespace, witness)
}
