...
const (
	...
	badBlockLimit       = 10
	TriesInMemory       = 128 * 64 // Retaining the last 24 hours historic data in memory
...
var defaultCacheConfig = &CacheConfig{
	TrieCleanLimit: 256 * 64,
	TrieDirtyLimit: 256 * 64,
	TrieTimeLimit:  60 * 32 * time.Minute,
	SnapshotLimit:  256 * 64,
	SnapshotWait:   true,
}
