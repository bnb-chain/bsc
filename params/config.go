...
type ChainConfig struct {
	...
	MiMCBlock           *big.Int `json:"mimcBlock,omitempty"`           // MiMC switch block (nil = no fork, 0 = already on mimc)
...
// IsMiMC returns whether num is either equal to the Merge fork block or greater.
func (c *ChainConfig) IsMiMC(num *big.Int) bool {
	return isForked(c.MiMCBlock, num)
}
