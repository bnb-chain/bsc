...
var (
	...
	// used for testing:
	//					[1,9] except 2 --> used as turn term directly
	//								 2 --> use random values to test switching turn terms
	//				0 and other values --> get turn term from contract
	FixedTurnTerm uint64 = 0
)
