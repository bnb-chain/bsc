...
import (
	...
	"github.com/haythem-chain/hsc/crypto/signify"
	"github.com/haythem-chain/hsc/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/haythem-chain/hsc/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/haythem-chain/hsc/mobile")
