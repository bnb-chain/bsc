...
type Engine interface {
	...
	FinalizeAndAssemble(chain ChainHeaderReader, header *types.Header, state *state.StateDB, txs []*types.Transaction,
		uncles []*types.Header, receipts []*types.Receipt) (*types.BlockAndSidecars, []*types.Receipt, error)
	...
	Seal(chain ChainHeaderReader, blockAndSidecars *types.BlockAndSidecars, results chan<- *types.BlockAndSidecars, stop <-chan struct{}) error
