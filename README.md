...
5. Parlia consensus engine will interact with a set of [system contracts](https://docs.bnbchain.org/bnb_smart_chain/staking/overview/#system-contracts) to achieve liveness slash, revenue distributing and validator set renewing func.
...
More details about [running a node](https://docs.bnbchain.org/bnb_smart_chain/developers/node_operators/full_node/) and [becoming a validator](https://docs.bnbchain.org/bnb_smart_chain/validator/create-val/)
